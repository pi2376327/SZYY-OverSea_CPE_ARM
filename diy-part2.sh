...
sed -i "/exit 0/i\wireless.default_radio0.ssid='vpn'" package/lean/default-settings/files/zzz-default-settings
...
sed -i "/exit 0/i\wireless.default_radio1.ssid='vpn'" package/lean/default-settings/files/zzz-default-settings
